...
#include "transmissionProximalToDistal.h"


int main(int argc, char **argv)
{
  
  ros::init(argc, argv, "transmissionProximalToDistal_node");
  // ROS_INFO_STREAM("Start of the node : transmissionProximalToDistal_node");
